  ...
  <div class="app-container">
    ...
    >
      ...
      <div class="dialog-footer">
        <el-button size="small" @click="handleCommitApplicationScenario(1)" class="next-step" v-show="scenarioRelation.status==1 || scenarioRelation.status==4">提交</el-button>
...
//设置频率单位s
      ...
      handleCommitApplicationScenario(type){
        let applicationScenarioAddParam = {
          ...
          scenarioRelation:this.scenarioRelation,
          type:type
        };
